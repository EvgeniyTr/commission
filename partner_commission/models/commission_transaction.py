...
class CommissionTransaction(models.Model):
    ...
    def _compute_amounts(self):
        for rec in self:
            ...
            # By default take VAT rate from the agreement, but for certain
            # payment methods (e.g. SBP / Faster Payments) VAT should not
            # participate in the calculation — treat it as 0%.
